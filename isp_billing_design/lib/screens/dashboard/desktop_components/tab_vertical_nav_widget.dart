...
class TabVerticalNavWidget extends StatefulWidget {
  @override
  _TabVerticalNavWidgetState createState() => _TabVerticalNavWidgetState();
}

class _TabVerticalNavWidgetState extends State<TabVerticalNavWidget> {
